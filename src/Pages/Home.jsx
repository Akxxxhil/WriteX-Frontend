        ...
        <>
            <div className="w-full max-w-xs">
                <input
                    ...
                    type="text"
                    placeholder="Search"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent"
                />
            </div>
                        ...
                        return (
                            <div key={index} className='my-5 border-b border-gray-300 pb-2 flex flex-col gap-2'>
                                ...
                                <div className='flex items-center gap-10'>
                                    ...
                                    <div className='cursor-pointer' title='Retweet'><PiBookmarkSimple size={"20px"} /></div>
